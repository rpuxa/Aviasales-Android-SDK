...
public class SearchFormFragment extends BaseFragment implements SimpleSearchFormView.SimpleSearchFormInterface,
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == R.id.privacy_policy) {
      Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(PrivacyPolicyUrl.getUrl()));
  ...
  private void setupViews(final ViewGroup layout) {
    ...
    btnTripClass = layout.findViewById(R.id.btn_trip_class);
    tvTripClass = layout.findViewById(R.id.tv_trip_class);

    btnSearch = layout.findViewById(R.id.btn_search);

    simpleSearchFormView = layout.findViewById(R.id.simple_search_view);
    complexSearchFormView = layout.findViewById(R.id.complex_search_view);
