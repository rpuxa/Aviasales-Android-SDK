...
dependencies {
    compile 'ru.aviasales.template:aviasalesSdk:2.1.15-sdk'
}
```
...
dependencies {
    compile 'ru.aviasales.template:aviasalesSdkTemplate:2.1.15'
}
```
...
```gradle
dependencies {
    compile 'ru.aviasales.template:appodeallib:2.1.15'
}
```
